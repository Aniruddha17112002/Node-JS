...
> A module is a file that exports values using module.exports, and those values are imported using require(), which always returns whatever is assigned to module.exports.                                                                                            Readme.md file